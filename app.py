...
# ตั้งค่าหน้าเว็บ
st.set_page_config(
    page_title="ระบบพิมพ์บันทึกข้อความราชการและแดชบอร์ด",
    page_icon="📝",
    layout="wide",
)
...
st.title("📝 ระบบพิมพ์ร่างบันทึกข้อความราชการอัจฉริยะ")
st.markdown("ระบบช่วยสังเคราะห์และจัดฟอร์มหนังสือตามหลักสารบรรณ พร้อมระบบติดตามสถิติและประวัติ")
